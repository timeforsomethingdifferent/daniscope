...
HTML=os.path.join(GL,"dashboard.html"); PORT=8765; VERSION="1.20"
CURATED={
 ...
 'coreaudiod':'macOS Core Audio, the system sound engine. Mild use is normal whenever audio plays. Constantly high usually points to one specific audio app or device, see SoundSource or your headset.',
 'arkaudiod':'Audio processing for a connected device. In your setup this is most likely SoundSource or your USB headset/DAC audio chain. Quick test: quit SoundSource, if this drops or disappears that is the source; if it stays, it is the headset/DAC driver.',
 'arcaudiod':'Audio processing for a connected device. Most likely SoundSource or your USB headset/DAC. Test: quit SoundSource and watch this, if it falls then SoundSource was driving it; if not, it is the headset/DAC.',
 ...
 'continuitycaptureagent':'Using your iPhone as a webcam via Continuity Camera. This is a known CPU cost, a dedicated USB webcam avoids it.',
 ...
 'monogram':"Monogram Creator - software for the Monogram physical control deck. If you do not own the hardware, you can quit it.",
...
<div class="navr"><div class="tabs"><div class="tab on" data-t="now">Right now</div><div class="tab" data-t="today">Today</div><div class="tab" data-t="long">Long-term</div></div><button id="gapbtn" class="lgbtn navgap invis"></button><button id="updind" class="updind"></button><button id="cog" class="cog" title="Settings">&#9881;</button></div></header>
